...
const GalleryShow = (props) => {
  ...
  let [redirectToGalleryIndex, setRedirectToGalleryIndex] = useState(false);
  ...
  const handleDelete = () => {
    picsToGals.forEach(picToGal => {
      deletePicturesToGallery(picToGal)
    })
    deleteGallery(gallery.id)
      .then(
        setRedirectToGalleryIndex(true)
      );
  };
  ...
  const handleUnfollow = () => {
    ...
    deleteFollow({
      user_id: session,
      followee_id: gallery.creator_id,
    })
      .then(() => {
