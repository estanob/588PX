            ...
            <div className="pic-title-and-likes">
              <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path 
                  fillRule="evenodd" 
                  clipRule="evenodd" 
                  d="M22.1752 2.9322L22.1658 2.9228C21.0104 1.69572 19.3996 1 
                    17.7142 1C16.0287 1 14.418 1.69572 13.2626 2.9228L12.0005 
                    4.23995L10.7384 2.9228C9.58121 1.69427 7.96779 0.99854 
                    6.28007 1.00032C4.59236 1.0021 2.98041 1.70123 1.82581 
                    2.9322C-0.608605 5.52036 -0.608605 9.55603 1.82581 
                    12.1442L11.544 22.288C11.6633 22.4124 11.8282 22.4828 
                    12.0005 22.4828C12.1729 22.4828 12.3377 22.4124 12.457 
                    22.288L22.1752 12.1442C24.6083 9.5555 24.6083 5.52089 
                    22.1752 2.9322ZM21.2622 11.2701L11.9978 20.9373L2.73345 
                    11.2701C0.759025 9.16831 0.763144 5.89237 2.74285 
                    3.79553C3.66011 2.81795 4.94091 2.26339 6.28144 
                    2.26339C7.62196 2.26339 8.90276 2.81795 9.82002 
                    3.79553L11.544 5.59067C11.7977 5.83903 12.2033 5.83903 
                    12.457 5.59067L14.1756 3.79553C15.0947 2.81543 16.379 
                    2.26027 17.7226 2.26231C19.0662 2.26435 20.3488 2.82339 
                    21.2649 3.80627C23.2365 5.90359 23.2365 9.1728 21.2649 
                    11.2701H21.2622Z" 
                  fill="#222222"></path>
              </svg>
              <h1>{picture.title}</h1>
              <p>{picLikes ? picLikes.length : '0'} Likes</p>
            </div>
            {/* <h1>{picture.title}</h1> */}
