...
picture2 = Picture.create!(
  title: 'Lively Shopping District', 
  location: 'Hsi Men Ting, Taipei, TaiWan', 
  caption: 'Best area to shop in Taiwan, can buy many things', 
  uploader_id: user2.id
)
...
picture3 = Picture.create!(
  ...
  caption: 'ater so clear you can see your feet in the sand', 
...
picture5 = Picture.create!(
  ...
  caption: "Look! It's hills that look like Chocolate!!!", 
...
picture6 = Picture.create!(
  ...
  caption: 'Hike up the hill to see this giant cross', 
  uploader_id: user3.id
)
